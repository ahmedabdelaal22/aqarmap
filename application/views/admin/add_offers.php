        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('admin/add-offers'); ?>">
            <div class="col-md-12">
              <div class="box-body">
									...
									<div class="form-group">
										...
										<select class="form-control" name="restaurant_id" required>
											...
											<?php foreach ($resturants as $listing) : ?>
												<option value="<?php echo $listing['res_id']; ?>" ><?php echo $listing['res_name']; ?></option>
											<?php endforeach; ?>
										</select>
									</div>
                  <div class="col-md-12">
											...
											<div class="input-group">
												<input type="number" class="form-control" id="exampleInputfnm" placeholder="Enter dicount"  name="dicount">
