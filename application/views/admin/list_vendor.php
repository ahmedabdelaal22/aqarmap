...
$vendor = $this->admin_model->get_vendor();
?>
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1><i class="nav-icon fa fa-users"></i> Vendor</h1>
				</div>
				<div class="col-sm-6">
									...
									<?php if (isset($vendor)) {
										...
										<?php foreach ($vendor as $row) { ?>
											<tr>
												...
												<td>
													<?php
													$profile = explode(":", $row->profile_image);
													if ($profile[0] == "https" || $profile[0] == "http") { ?>
														<img src="<?php echo $row->profile_image ?>" class="image brand-image img-circle elevation-3" height="40" width="40">
													<?php } else { ?>
												...
												<td style="display: inline-flex;">
													<a class="btn btn-sm btn-info" href="<?php echo base_url('admin/edit-vendor/' . $row->id); ?>"><i class="fa fa-edit"></i></a>
