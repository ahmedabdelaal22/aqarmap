...
<head>
  ...
  <link rel="icon" href="<?php echo base_url();?>uploads/transparent_n_80.png" type="image/png" sizes="16x16">
  <title>Nylitical | Log in</title>
...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="<?php echo base_url();?>admin/login"><img style="height:100px;width: 100px;" src="<?php echo base_url(); ?>uploads/nlytical_n copy.jpg"></a>
  </div>
