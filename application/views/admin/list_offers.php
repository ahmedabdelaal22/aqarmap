               ...
               <div class="card-body">
                  <table id="category_table" class="table table-bordered table-striped">
                     ...
                     <tr>
                       ...
                       <td><?php echo $row->dicount; ?></td>
                       
                       <td><img src="<?php echo base_url('uploads/').$row->image?>" class="image" height="50" width="50"></td>

                       <td style="display: inline-flex;">
                         <a class="btn btn-sm btn-info margin-5" href="<?php echo base_url('admin/edit-offers/'.$row->id); ?>"><i class="fa fa-edit"></i></a>
...
<div class="modal fade in" id="modalDel">
  <div class="modal-dialog" >
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo base_url('admin/trash-offers'); ?>" id="frmDel">
