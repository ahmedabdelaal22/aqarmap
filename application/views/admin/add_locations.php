        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" enctype="multipart/form-data" action="<?php echo base_url('admin/add-locations'); ?>">
            <div class="col-md-12">
              <div class="box-body">

                <div class="form-group">
                  <label for="exampleInputfnm"> Name (ar)</label>
                  <input type="text" class="form-control" id="exampleInputfnm" placeholder="Enter Name" name="name_ar">
                  <?php echo form_error('name_ar'); ?>
                </div>

                <div class="form-group">
                  <label for="exampleInputfnm">Name (en)</label>
                  <input type="text" class="form-control" id="exampleInputfnm" placeholder="Enter Name" name="name_en">
